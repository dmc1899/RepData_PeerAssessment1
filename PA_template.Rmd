...
The mean of the total steps per day `r mean_total_steps_per_day` and the median of the total steps per day `r median_total_steps_per_day` are also calculated.
...
The interval with the highest number of steps - `r highest_interval` - is also calculated.
...
The mean of the total steps per day `r mean_total_imputed_steps_per_day` and the median of the total steps per day `r median_total_imputed_steps_per_day` are also calculated.  It can be observed that both the mean and the median have slightly decreased in comparison to the mean and median values from the copy of the source dataset with NA values removed.
